...
def test_software_release_manifest_is_internally_consistent():
    manifest_path = ROOT / "configs/software_implementation_release_v6.json"
    manifest = json.loads(manifest_path.read_text(encoding="utf-8"))

    assert manifest["release_id"] == "software-implementation-v6"
    assert manifest["predecessor"] == "software-implementation-v5"
...
def test_v1_through_v5_release_manifests_exist_as_historical_records():
    for path, release_id, predecessor in (
        ...
        ("configs/software_implementation_release_v4.json", "software-implementation-v4", "software-implementation-v3"),
        ("configs/software_implementation_release_v5.json", "software-implementation-v5", "software-implementation-v4"),
    ):
