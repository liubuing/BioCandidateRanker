...
def main():
    ...
    protocol_path=ROOT/'configs/catpred_mode_b_protocol_v2.json'
    ...
    target=BASE/'full-v2'/f'seed{args.seed}'
    ...
    command=[sys.executable,'-u',str(ROOT/'scripts/catpred_noncanonical_entry.py'),
